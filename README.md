...
| 考核阶段 | 时间安排 | 考核目标与通关标准 |
| :---: | :---: | :--- |
| **初试 (Phase 1)** | 每年 9 月中旬 | **基础能力**：掌握 C/C++ 基础语法，了解基础数据结构，对嵌入式或 Linux 有初步认识和极大热情。 |
| **复试 (Phase 2)** | 每年 10 月中旬 | **实战验证**：能够独立完成单片机基础外设配置，了解电机驱动原理，或能在上位机跑通基础的 ROS 节点。 |
| **终考 (Final)** | 每年 11 月底 | **项目实操**：独立完成闭环控制（如 PID 速度环调参），或成功部署并运行指定的 SLAM 算法，代码需具备良好的规范性。 |
